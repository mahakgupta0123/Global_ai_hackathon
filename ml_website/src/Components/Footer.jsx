      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex-shrink-0">
            ...
            <br></br>
            <div>
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6 ml-5">
                {/* Discord */}
                <Link
                  to="#"
                  className="text-gray-700 hover:text-gray-500 transition-colors border-2 p-2 sm:p-3 rounded-xl"
                >
                  <svg
